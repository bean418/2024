...
# train
files <- paste0("/Users/bean418/PCRL/data/sensor", 1:4, ".csv")
...
dim(s1_train)
ggplot() +
  geom_line(data = s1_train, aes(x = 1:1125, y = X35, color = "sensor1")) +
  geom_line(data = s2_train, aes(x = 1:1125, y = X35, color = "sensor2")) +
  geom_line(data = s3_train, aes(x = 1:1125, y = X35, color = "sensor3")) +
  geom_line(data = s4_train, aes(x = 1:1125, y = X35, color = "sensor4")) +
